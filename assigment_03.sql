...
-- Question 7: Lấy ra ID của question có >= 4 câu
SELECT 	question_id
From answer
GROUP BY question_id
HAVING COUNT(answer_id) >=4;
-- Question 8: Lấy ra các mã đề thi có thời gian thi >= 60 phút và được tạo TRƯỚC NAGYF 20/12/2019 GR
SELECT code
From exam
WHERE dueation >60 AND created_date < "2019/12/20";
-- trước ngày
-- 20/12/2019
...
DELETE FROM exam 
WHERE exam AND created_date <"2019/12/20";
